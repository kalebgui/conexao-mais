...
<body>
  ...
  <div class="alert">
    ...
    <form method="post" action="../controller/excluirPrefeitocontrollerS.php?id=<?php echo $idprefeitura?>&usuario=<?=$usuario?>">
      <button type="submit" name="confirm">Sim, excluir</button>
      <button type="button" onclick="window.location.href='../view/listarusuarios.php'">Cancelar</button>
    </form>
  </div>
</body>
</html>
