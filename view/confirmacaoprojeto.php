...
<body>
  ...
  <div class="alert">
    ...
    <form method="post" action="../controller/excluirProjetocontroller.php?id=<?= $idprojeto?>">
      <button type="submit" name="confirm">Sim, excluir</button>
      <button type="button" onclick="window.location.href='../view/centro.php'">Cancelar</button>
    </form>
  </div>
</body>
</html>
